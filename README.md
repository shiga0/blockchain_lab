...
| 観点 | Core | Bitcoin | Kaspa | Ethereum | Solana | Cosmos | Avalanche | Cardano | Polkadot | Sui | Aptos |
|------|------|---------|-------|----------|--------|--------|-----------|---------|----------|-----|-------|
| データモデル | UTXO | UTXO | UTXO | Account | Account+Owner | Account+ABCI | Multi-VM | eUTXO | Relay+Para | Object-centric | Account+Resource |
| コンセンサス | PoW | PoW | PoW + GHOSTDAG | PoS | PoH + Tower BFT | Tendermint BFT | Snowball | Ouroboros | BABE+GRANDPA | Mysticeti DAG | AptosBFT DAG |
| ブロック構造 | 線形 | 線形 | DAG | 線形 | Slot-Entry | 線形+Commit | Snowman/DAG | スロット | Relay+Para | Mysticeti DAG | AptosBFT DAG |
| ハッシュ | SHA256 | Double SHA256 | BLAKE2b | Keccak-256 | SHA256 | SHA256 | SHA256 | BLAKE2b | BLAKE2-256 | BLAKE2b-256 | SHA256/SHA3 |
| 署名曲線 | P-256 | secp256k1 | secp256k1 | secp256k1 | Ed25519 | secp256k1/Ed25519 | secp256k1 | Ed25519 | Sr25519 | Multi (Ed25519等) | Multi (Ed25519等) |
| ブロック時間 | 可変 | 10分 | 1秒 | 12秒 | 400ms | 1-7秒 | 1-2秒 | 1秒 | 6秒 | ~500ms | ~1秒 |
| ファイナリティ | 確率的 | 確率的 | 確率的 | 経済的 | 経済的 | 即時 | 確率的 | 確率的 | 決定論的 | 決定論的 | 決定論的 |
